...
QUIZ_TITLES = {
    'quiz1_intro_dm': 'Quiz 1 : Introduction & analyse de données',
    'quiz2_fim': 'Quiz 2 : Frequent Itemset Mining & règles',
    'quiz3_clustering_spm': 'Quiz 3 : Clustering & Sequential Pattern Mining',
}
...
def main():
    # Configuration
    repo = os.environ.get('GITHUB_REPOSITORY', 'johnaoga/gl-dm')
